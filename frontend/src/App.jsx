...
function App() {
  ...
  return (
    <div className="min-h-screen flex text-slate-800 font-inter bg-slate-50/30">
      {!isAuthenticated ? (
          ...
          <aside className="w-72 bg-white/80 backdrop-blur-xl border-r border-slate-200/50 p-6 flex flex-col fixed h-full z-10 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
            ...
            <div className="mb-6 p-4 bg-indigo-50/50 rounded-2xl border border-indigo-100/50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-bold text-indigo-400 uppercase tracking-wider">Learner</p>
                  <p className="text-sm font-bold text-slate-700 truncate w-32">{username}</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-auto space-y-2">
              ...
              <button
                ...
                className="w-full flex items-center gap-2 text-slate-400 hover:text-rose-500 transition-colors p-3 text-sm font-bold rounded-xl hover:bg-rose-50 group border-t border-slate-100 mt-2 pt-4"
              >
